    ...
    <footer className="border-t border-border/50 bg-background/50 backdrop-blur-sm pt-16 pb-8">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground max-w-sm leading-relaxed">
              Capturing the raw beauty of nature through the lens. Specializing
              in rare avian species, wildlife portraits, and atmospheric
              landscapes.
            </p>
          </div>
        ...
        <div className="border-t border-border/50 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
          <p>
            © {new Date().getFullYear()} WildLens Photography. All rights
            reserved.
          </p>
